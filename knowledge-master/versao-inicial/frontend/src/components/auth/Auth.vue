<template>
  <div class="auth-content">
    <div class="auth-modal">
      ...
      <input v-if="showSignup" name="nome" v-model="user.name" placeholder="Nome" type="text">
      ...
      <input v-if="showSignup" v-model="user.confirmPassword" name="confirmPassword" placeholder="Confirme a senha" type="password">
